// Simple background removal (WebCam)
...
void setup() {
  ...
  backgroundImage = createImage(640, 480, RGB);
  movie.loop();
...
void mousePressed() {
  ...
  backgroundImage.copy(movie, 0, 0, movie.width, movie.height, 0, 0, movie.width, movie.height);
